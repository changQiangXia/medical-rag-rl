# 发布质量门禁报告：release_quality_gate_clean4_v1

- 生成时间：2026-02-28T09:33:57
- 模型数：3
- 通过模型数：0
- 全量通过：NO
...
| prompt_residue_count | 12.0 | == 0.0 | FAIL |  |
| incomplete_doc_tail_count | 8.0 | == 0.0 | FAIL |  |
| human_overall_0_5 | NA | >= 3.0 | PASS | human score not provided for this model |

### dpo_1k_v2_clean4

- 指标文件：`artifacts/metrics/dpo_1k_v2_clean4_max.json`
- 预测文件：`outputs/baseline/dpo_1k_v2_clean4_max.jsonl`

| 检查项 | 观测值 | 阈值 | 通过 | 备注 |
| --- | ---: | --- | --- | --- |
| avg_citation_consistency | 0.74 | >= 0.6 | PASS |  |
| avg_evidence_hit_rate | 0.74 | >= 0.65 | PASS |  |
| avg_doc_tag_repeat_ratio | 0.0 | <= 0.05 | PASS |  |
| avg_safety_refusal_rate | 0.0 | <= 0.05 | PASS |  |
| avg_token_f1 | 0.5039 | >= 0.5 | PASS |  |
| no_citation_ratio | 0.26 | <= 0.45 | PASS |  |
| empty_response_count | 0.0 | == 0.0 | PASS |  |
| chat_marker_count | 0.0 | == 0.0 | PASS |  |
| malformed_doc_tag_count | 0.0 | == 0.0 | PASS |  |
| prompt_residue_count | 0.0 | == 0.0 | PASS |  |
| incomplete_doc_tail_count | 2.0 | == 0.0 | FAIL |  |
| human_overall_0_5 | NA | >= 3.0 | PASS | human score not provided for this model |
...
| malformed_doc_tag_count | 0.0 | == 0.0 | PASS |  |
| prompt_residue_count | 0.0 | == 0.0 | PASS |  |
| incomplete_doc_tail_count | 7.0 | == 0.0 | FAIL |  |
| human_overall_0_5 | NA | >= 3.0 | PASS | human score not provided for this model |
